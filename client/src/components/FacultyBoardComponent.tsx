...
export function FacultyBoard() {
  ...
  return (
    <div className='p-4 sm:p-6 md:p-8 border rounded-lg dark:bg-gray-900'>
      <h2 className='text-2xl font-semibold text-gray-900 dark:text-white mb-4 text-center'>Faculty Board</h2>
      <div className='relative overflow-x-auto shadow-lg rounded-lg'>
        <Table hoverable className='min-w-full bg-white dark:bg-gray-800'>
          <Table.Head className='bg-gray-100 dark:bg-gray-700'>
            ...
            <Table.HeadCell className='px-4 py-3'>Predicted Appraisal</Table.HeadCell>
